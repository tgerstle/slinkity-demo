const { convertTime, makeDateTagMap, productsSortFunc, isHTML, escapeHTML } = require('../component/_collectionPage.cjs');
const { altAttCodes, tagTranslations, tagPrefixes, getImages } = require('../component/_imgTagOptions.cjs');
const { standardizeValue } = require('./../../utilities/_standardizeValue.cjs');
const { stripString } = require('./../../utilities/_stripString.cjs');
const { decodeEntities } = require('../../utilities/_decodeEntities.cjs');
